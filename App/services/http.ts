...
// //   import {accessTokenSelector, domainSelector} from '../redux/selectors';
//   // import Navigator from '../navigation/NavigationService';
// //   import {deviceInfoSelector} from '../redux/selectors/appSelector';
//   import {IDeviceInfo} from '../redux/reducers/appReducer';
//   // import SCREEN_NAME from '../navigation/ScreenName';
//   import {CustomError} from '../redux/helper/handleErrorMessage'; // Access token retrieval
    ...
    api.interceptors.response.use(
      ...
      (error: any) => {
        ...
        if (code && this.exceptionCodes.includes(code)) {
          // Navigator.navigateAndSimpleReset(SCREEN_NAME.);
        }
        if (message) {
